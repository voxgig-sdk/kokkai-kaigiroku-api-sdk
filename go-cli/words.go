...
func registerSDKWords(r *eng.Registry, client *sdk.KokkaiKaigirokuApiSDK) {
...
func runOp(client *sdk.KokkaiKaigirokuApiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
