...
AQL-driven CLI and REPL for the KokkaiKaigirokuApi SDK. Positional arguments are
...
```sh
go build -o kokkai-kaigiroku-api-cli ./...
```
...
./kokkai-kaigiroku-api-cli load 1 meeting
./kokkai-kaigiroku-api-cli load '{id:1}' meeting
