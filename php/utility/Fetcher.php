...
// KokkaiKaigirokuApi SDK utility: fetcher

class KokkaiKaigirokuApiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KokkaiKaigirokuApiSDK/1.0)';
    ...
    public static function call(KokkaiKaigirokuApiContext $ctx, string $fullurl, array $fetchdef): array
    {
