...
// KokkaiKaigirokuApi SDK utility: graphql
//
...
class KokkaiKaigirokuApiGraphql
{
    ...
    // equivalent.
    public static function body(KokkaiKaigirokuApiContext $ctx): mixed
    {
    ...
    public static function errors(KokkaiKaigirokuApiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
