# KokkaiKaigirokuApi PHP SDK

The PHP SDK for the KokkaiKaigirokuApi API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Meeting(null)->list(null, null);
...
[$result, $err] = $client->KokkaiKaigirokuApi(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── kokkaikaigirokuapi_sdk.php          -- Main SDK class
...
The main class (`kokkaikaigirokuapi_sdk.php`) exports the SDK class
