...
// KokkaiKaigirokuApi SDK Speech entity
...
class SpeechEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SpeechEntity($this->_client, $opts);
    }

    /**
     * @param Speech|array $args Speech data (assoc-array) to store.
     */
    ...
    /**
     * @return Speech|array The current Speech data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Speech fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Speech fields).
     */
    ...
    /**
     * List Speech items matching the given filter.
     *
     * @param SpeechListMatch|array|null $reqmatch Match filter (any subset
     *   of Speech fields) as an assoc-array; SpeechListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Speech[]|array A list of Speech items as assoc-arrays at
