...
// KokkaiKaigirokuApi SDK timeout feature
...
class KokkaiKaigirokuApiTimeoutFeature extends KokkaiKaigirokuApiBaseFeature
{
    ...
    private function _with_timeout(KokkaiKaigirokuApiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KokkaiKaigirokuApiContext $_ctx, float $ms): void
    {
        $client = $this->client;
