...
// KokkaiKaigirokuApi SDK metrics feature
...
class KokkaiKaigirokuApiMetricsFeature extends KokkaiKaigirokuApiBaseFeature
{
    ...
    private function _record(KokkaiKaigirokuApiContext $ctx, bool $ok): void
    {
