...
// KokkaiKaigirokuApi SDK proxy feature
...
class KokkaiKaigirokuApiProxyFeature extends KokkaiKaigirokuApiBaseFeature
{
    ...
    public function init(KokkaiKaigirokuApiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KokkaiKaigirokuApiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
