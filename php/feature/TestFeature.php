...
// KokkaiKaigirokuApi SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class KokkaiKaigirokuApiTestFeature extends KokkaiKaigirokuApiBaseFeature
{
    ...
    public function init(KokkaiKaigirokuApiContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (KokkaiKaigirokuApiContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = KokkaiKaigirokuApiParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (KokkaiKaigirokuApiContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(KokkaiKaigirokuApiContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = KokkaiKaigirokuApiParam::call($ctx, $k);
