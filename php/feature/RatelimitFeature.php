...
// KokkaiKaigirokuApi SDK ratelimit feature
...
class KokkaiKaigirokuApiRatelimitFeature extends KokkaiKaigirokuApiBaseFeature
{
    ...
    private function _acquire(KokkaiKaigirokuApiContext $ctx): void
    {
    ...
    private function _track(KokkaiKaigirokuApiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
