...
class SpeechDirectTest extends TestCase
{
    public function test_direct_list_speech(): void
    {
        $setup = speech_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-speech", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
