...
// KokkaiKaigirokuApi SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KokkaiKaigirokuApiSDK::test)
...
{
    private const SDK_CLASS = 'KokkaiKaigirokuApiSDK';
    ...
    private const SDK_BASE = 'kokkaikaigirokuapi_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../kokkaikaigirokuapi_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
