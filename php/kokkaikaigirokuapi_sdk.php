...
class KokkaiKaigirokuApiSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = KokkaiKaigirokuApiHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = KokkaiKaigirokuApiHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!KokkaiKaigirokuApiFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, KokkaiKaigirokuApiFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return KokkaiKaigirokuApiUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = KokkaiKaigirokuApiHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = KokkaiKaigirokuApiHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = KokkaiKaigirokuApiHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new KokkaiKaigirokuApiError($op . "_allow",
                "KokkaiKaigirokuApiSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = KokkaiKaigirokuApiHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new KokkaiKaigirokuApiError("graphql_error",
                "KokkaiKaigirokuApiSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function MeetingList($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_meeting_list === null) {
                $this->_meeting_list = new MeetingListEntity($this, null);
            }
            return $this->_meeting_list;
        }
        return new MeetingListEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new KokkaiKaigirokuApiSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
