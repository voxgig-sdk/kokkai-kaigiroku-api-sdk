...
type Args struct {
	Entity string         `json:"entity" jsonschema:"meeting | meeting_list | speech"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.KokkaiKaigirokuApiSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "kokkai-kaigiroku-api_list",
		Description: "List records from KokkaiKaigirokuApi. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "kokkai-kaigiroku-api_load",
		Description: "Load a single record from KokkaiKaigirokuApi. " +
...
func runOp(client *sdk.KokkaiKaigirokuApiSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.KokkaiKaigirokuApiSDK, name string) (sdk.KokkaiKaigirokuApiEntity, error) {
	switch strings.ToLower(name) {
	case "meeting":
		return client.Meeting(nil), nil
	case "meeting_list":
		return client.MeetingList(nil), nil
	case "speech":
