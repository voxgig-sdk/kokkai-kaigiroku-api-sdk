// Command KokkaiKaigirokuApi-mcp is an MCP server exposing the KokkaiKaigirokuApi
// SDK as MCP tools.
//
// Two tools are registered:
//
//	KokkaiKaigirokuApi_list  — list records of an entity
//	KokkaiKaigirokuApi_load  — load a single record of an entity
//
