...
// KokkaiKaigirokuApi SDK utility: make_options

class KokkaiKaigirokuApiMakeOptions
{
    ...
    public static function call(KokkaiKaigirokuApiContext $ctx): array
    {
        ...
        //
        // `KokkaiKaigirokuApiSchema::optspec()` is built from the model:
        ...
        $optspec = KokkaiKaigirokuApiSchema::optspec();
