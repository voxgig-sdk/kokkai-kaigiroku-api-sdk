...
// KokkaiKaigirokuApi SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class KokkaiKaigirokuApiMakeRequest
{
    public static function call(KokkaiKaigirokuApiContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new KokkaiKaigirokuApiResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new KokkaiKaigirokuApiResponse($fetched);
        } else {
