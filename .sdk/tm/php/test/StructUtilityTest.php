...
// KokkaiKaigirokuApi SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = KokkaiKaigirokuApiOmni::makeStructRunner(
    ...
    {
        return KokkaiKaigirokuApiOmni::objmodel(KokkaiKaigirokuApiOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return KokkaiKaigirokuApiOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return KokkaiKaigirokuApiOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(KokkaiKaigirokuApiOmni::structfix($now, Struct::undef()))
                        !== json_encode(KokkaiKaigirokuApiOmni::structfix($val, Struct::undef()))) {
