...
// KokkaiKaigirokuApi SDK pipeline test
//
...
{
    private static function utility(): KokkaiKaigirokuApiUtility
    {
        return new KokkaiKaigirokuApiUtility();
    }
    ...
    private static function ctx(array $over = []): KokkaiKaigirokuApiContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new KokkaiKaigirokuApiContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new KokkaiKaigirokuApiOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof KokkaiKaigirokuApiError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new KokkaiKaigirokuApiOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = KokkaiKaigirokuApiMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new KokkaiKaigirokuApiOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = KokkaiKaigirokuApiMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new KokkaiKaigirokuApiOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = KokkaiKaigirokuApiMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KokkaiKaigirokuApiSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = KokkaiKaigirokuApiMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new KokkaiKaigirokuApiResponse([]),
            'result' => new KokkaiKaigirokuApiResult([]),
        ]);
        [, $err] = KokkaiKaigirokuApiMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new KokkaiKaigirokuApiSpec([]),
            'response' => null,
            'result' => new KokkaiKaigirokuApiResult([]),
        ]);
        [, $err] = KokkaiKaigirokuApiMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new KokkaiKaigirokuApiSpec(['step' => 's']),
            'response' => new KokkaiKaigirokuApiResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new KokkaiKaigirokuApiResult([]),
        ]);
        [, $err] = KokkaiKaigirokuApiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new KokkaiKaigirokuApiSpec(['step' => 's']),
            'response' => new KokkaiKaigirokuApiResponse(self::resp(200, ['v' => 1])),
            'result' => new KokkaiKaigirokuApiResult([]),
        ]);
        [, $err] = KokkaiKaigirokuApiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new KokkaiKaigirokuApiSpec(['step' => 's']),
            'response' => new KokkaiKaigirokuApiResponse(self::resp(200, ['v' => 2])),
            'result' => new KokkaiKaigirokuApiResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        KokkaiKaigirokuApiMakeResponse::call($ctx);
    ...
    {
        $preset = new KokkaiKaigirokuApiResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new KokkaiKaigirokuApiSpec([]),
            'response' => new KokkaiKaigirokuApiResponse([]),
            'result' => new KokkaiKaigirokuApiResult([]),
        ...
        [$got, $err] = KokkaiKaigirokuApiMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new KokkaiKaigirokuApiResult([])]);
        [, $err] = KokkaiKaigirokuApiMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new KokkaiKaigirokuApiSpec([]), 'result' => null]);
        [, $err] = KokkaiKaigirokuApiMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KokkaiKaigirokuApiSpec(['step' => 's']),
            'result' => new KokkaiKaigirokuApiResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new KokkaiKaigirokuApiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KokkaiKaigirokuApiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KokkaiKaigirokuApiSpec(['step' => 's']),
            'result' => new KokkaiKaigirokuApiResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new KokkaiKaigirokuApiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KokkaiKaigirokuApiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KokkaiKaigirokuApiResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new KokkaiKaigirokuApiSpec([]),
            'result' => new KokkaiKaigirokuApiResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = KokkaiKaigirokuApiMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = KokkaiKaigirokuApiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new KokkaiKaigirokuApiError('boom', 'boom');
        $utility->fetcher = function (KokkaiKaigirokuApiContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KokkaiKaigirokuApiSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = KokkaiKaigirokuApiMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (KokkaiKaigirokuApiContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = KokkaiKaigirokuApiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(KokkaiKaigirokuApiResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        KokkaiKaigirokuApiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (KokkaiKaigirokuApiContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KokkaiKaigirokuApiSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = KokkaiKaigirokuApiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new KokkaiKaigirokuApiResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new KokkaiKaigirokuApiSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = KokkaiKaigirokuApiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = KokkaiKaigirokuApiMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = KokkaiKaigirokuApiMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new KokkaiKaigirokuApiResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, KokkaiKaigirokuApiDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new KokkaiKaigirokuApiResult(['ok' => false])]);
        $this->expectException(KokkaiKaigirokuApiError::class);
        KokkaiKaigirokuApiDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new KokkaiKaigirokuApiResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', KokkaiKaigirokuApiMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        KokkaiKaigirokuApiMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new KokkaiKaigirokuApiBaseFeature();
        $b = new KokkaiKaigirokuApiBaseFeature();
        KokkaiKaigirokuApiFeatureAdd::call($ctx, $a);
        KokkaiKaigirokuApiFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): KokkaiKaigirokuApiBaseFeature
    {
        $f = new KokkaiKaigirokuApiBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        KokkaiKaigirokuApiFeatureAdd::call($ctx, self::named_feature('a'));
        KokkaiKaigirokuApiFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        KokkaiKaigirokuApiFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        KokkaiKaigirokuApiFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        KokkaiKaigirokuApiFeatureAdd::call($ctx, $replace);
        ...
        KokkaiKaigirokuApiFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): KokkaiKaigirokuApiContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new KokkaiKaigirokuApiSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = KokkaiKaigirokuApiPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        KokkaiKaigirokuApiPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new KokkaiKaigirokuApiResponse(['headers' => null]),
            'result' => new KokkaiKaigirokuApiResult([]),
        ]);
        KokkaiKaigirokuApiResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        KokkaiKaigirokuApiResultBody::call($ctx);
