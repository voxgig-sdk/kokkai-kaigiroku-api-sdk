...
// KokkaiKaigirokuApi SDK utility type

class KokkaiKaigirokuApiUtility
{
    ...
    public static function copy(KokkaiKaigirokuApiUtility $src): KokkaiKaigirokuApiUtility
    {
        $u = new KokkaiKaigirokuApiUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
