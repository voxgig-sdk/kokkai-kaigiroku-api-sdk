...
// KokkaiKaigirokuApi SDK audit feature
...
class KokkaiKaigirokuApiAuditFeature extends KokkaiKaigirokuApiBaseFeature
{
    ...
    private function _emit(KokkaiKaigirokuApiContext $ctx, string $outcome): void
    {
