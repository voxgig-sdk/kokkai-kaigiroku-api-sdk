...
// KokkaiKaigirokuApi SDK netsim feature
...
class KokkaiKaigirokuApiNetsimFeature extends KokkaiKaigirokuApiBaseFeature
{
    ...
    private function _simulate(KokkaiKaigirokuApiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(KokkaiKaigirokuApiContext $ctx, array $applied): void
    {
        $client = $this->client;
