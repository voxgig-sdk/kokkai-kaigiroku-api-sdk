...
// KokkaiKaigirokuApi SDK cache feature
...
class KokkaiKaigirokuApiCacheFeature extends KokkaiKaigirokuApiBaseFeature
{
    ...
    private function _through(KokkaiKaigirokuApiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
