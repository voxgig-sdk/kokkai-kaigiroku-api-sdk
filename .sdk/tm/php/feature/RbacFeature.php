...
// KokkaiKaigirokuApi SDK rbac feature
...
class KokkaiKaigirokuApiRbacFeature extends KokkaiKaigirokuApiBaseFeature
{
    ...
    private function _required(KokkaiKaigirokuApiContext $ctx): ?string
    {
    ...
    private function _reject(KokkaiKaigirokuApiContext $ctx, string $required): void
    {
    ...
    private function _track(KokkaiKaigirokuApiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
