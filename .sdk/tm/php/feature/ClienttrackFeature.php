...
// KokkaiKaigirokuApi SDK clienttrack feature
...
class KokkaiKaigirokuApiClienttrackFeature extends KokkaiKaigirokuApiBaseFeature
{
    ...
    public function PostConstruct(KokkaiKaigirokuApiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'KokkaiKaigirokuApi-SDK';
