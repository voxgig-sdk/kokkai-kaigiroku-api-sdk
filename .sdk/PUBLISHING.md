...
|---|---|---|
| `ts/` | @voxgig-sdk/kokkai-kaigiroku-api-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/kokkai-kaigiroku-api-sdk \
      --repository voxgig-sdk/kokkai-kaigiroku-api-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/kokkai-kaigiroku-api-sdk` shows it, and
`npm trust revoke @voxgig-sdk/kokkai-kaigiroku-api-sdk --id=<id>` removes it.
