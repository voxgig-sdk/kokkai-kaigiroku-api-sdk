...
local MeetingListEntity = {}
MeetingListEntity.__index = MeetingListEntity


function MeetingListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MeetingListEntity)
  self._name = "meeting_list"
  self._client = client
...
function MeetingListEntity:get_name()
  return self._name
end


function MeetingListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MeetingListEntity.new(self._client, opts)
end
...
function MeetingListEntity:mark_deleted()
  self._deleted = true
end


function MeetingListEntity:deleted()
  return true == self._deleted
end


function MeetingListEntity:data_set(args)
  if args ~= nil then
...
function MeetingListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MeetingListEntity:match_set(args)
  if args ~= nil then
...
function MeetingListEntity:match_get()
...
function MeetingListEntity:stream(action, args, callopts)
...
---@param reqmatch MeetingListListMatch
---@param ctrl? table
---@return MeetingList[]
---@return string? err
function MeetingListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function MeetingListEntity:_run_op(ctx, post_done)
  local utility = self._utility
