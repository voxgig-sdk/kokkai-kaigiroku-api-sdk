...
describe("MeetingEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set KOKKAIKAIGIROKUAPI_TEST_MEETING_ENTID JSON to run live")
      return
    end
...
function meeting_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("KOKKAIKAIGIROKUAPI_TEST_MEETING_ENTID")
