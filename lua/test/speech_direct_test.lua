...
describe("SpeechDirect", function()
  it("should direct-list-speech", function()
    local setup = speech_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-speech", setup.live and "live" or "unit")
...
function speech_direct_setup(mockres)
