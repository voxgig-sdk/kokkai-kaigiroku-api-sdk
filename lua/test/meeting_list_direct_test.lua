...
describe("MeetingListDirect", function()
  it("should direct-list-meeting_list", function()
    local setup = meeting_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-meeting_list", setup.live and "live" or "unit")
...
function meeting_list_direct_setup(mockres)
