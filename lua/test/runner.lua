...
function runner.env_override(m)
  local live = runner.getenv("KOKKAI_KAIGIROKU_API_TEST_LIVE")
  local override = runner.getenv("KOKKAI_KAIGIROKU_API_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("KOKKAI_KAIGIROKU_API_TEST_EXPLAIN")
