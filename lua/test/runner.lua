...
function runner.env_override(m)
  local live = runner.getenv("KOKKAIKAIGIROKUAPI_TEST_LIVE")
  local override = runner.getenv("KOKKAIKAIGIROKUAPI_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("KOKKAIKAIGIROKUAPI_TEST_EXPLAIN")
