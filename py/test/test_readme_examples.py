# KokkaiKaigirokuApi SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KokkaiKaigirokuApiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KokkaiKaigirokuApiSDK(...) and KokkaiKaigirokuApiSDK.test(...) become
#      KokkaiKaigirokuApiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "kokkaikaigirokuapi_sdk"
_SDK_CLASS = "KokkaiKaigirokuApiSDK"
