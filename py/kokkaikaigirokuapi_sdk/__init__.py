...
from kokkaikaigirokuapi_sdk.utility import register

# Load features
from kokkaikaigirokuapi_sdk.feature.base_feature import KokkaiKaigirokuApiBaseFeature
from kokkaikaigirokuapi_sdk.features import _has_feature, _make_feature
...
class KokkaiKaigirokuApiSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = KokkaiKaigirokuApiUtility()
    ...
    def get_utility(self):
        return KokkaiKaigirokuApiUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("KokkaiKaigirokuApiSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Meeting(self, data=None) -> "MeetingEntity":
        ...
        from kokkaikaigirokuapi_sdk.entity.meeting_entity import MeetingEntity
    ...
    def MeetingList(self, data=None) -> "MeetingListEntity":
        ...
        from kokkaikaigirokuapi_sdk.entity.meeting_list_entity import MeetingListEntity
    ...
    def Speech(self, data=None) -> "SpeechEntity":
        ...
        from kokkaikaigirokuapi_sdk.entity.speech_entity import SpeechEntity
