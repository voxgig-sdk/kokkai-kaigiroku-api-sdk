...
from kokkaikaigirokuapi_sdk.core.helpers import get_ctx_prop, to_map
...
class KokkaiKaigirokuApiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = KokkaiKaigirokuApiControl()
        ...
        if isinstance(sp, KokkaiKaigirokuApiSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, KokkaiKaigirokuApiResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, KokkaiKaigirokuApiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return KokkaiKaigirokuApiOperation({})
        ...
        op = KokkaiKaigirokuApiOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return KokkaiKaigirokuApiError(code, msg, self)
