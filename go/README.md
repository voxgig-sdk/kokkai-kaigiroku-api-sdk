...
meeting, err := client.Meeting(nil).Load(
    map[string]any{"id": "test01"}, nil,
)
if err != nil {
    panic(err)
}
fmt.Println(meeting) // the loaded mock data
```
...
slice):
    ...
    meeting, err := client.Meeting(nil).Load(map[string]any{"id": "example_id"}, nil)
    if err != nil { /* handle */ }
...
meeting.Load(map[string]any{"id": "example_id"}, nil)

// meeting.Data() now returns the loaded meeting data
