...
const testSeed = `map[string]any{"entity": map[string]any{"meeting": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "meeting_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "speech": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
