...
type KokkaiKaigirokuApiSDK struct {
	Mode     string
...
func (sdk *KokkaiKaigirokuApiSDK) OptionsMap() map[string]any {
...
func (sdk *KokkaiKaigirokuApiSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *KokkaiKaigirokuApiSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *KokkaiKaigirokuApiSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *KokkaiKaigirokuApiSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *KokkaiKaigirokuApiSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *KokkaiKaigirokuApiSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("KokkaiKaigirokuApiSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *KokkaiKaigirokuApiSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *KokkaiKaigirokuApiSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("KokkaiKaigirokuApiSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *KokkaiKaigirokuApiSDK {
	...
	sdk := NewKokkaiKaigirokuApiSDK(sdkopts)
	sdk.Mode = "test"
