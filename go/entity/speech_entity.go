...
func NewSpeechEntity(client *core.KokkaiKaigirokuApiSDK, entopts map[string]any) *SpeechEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SpeechEntity) GetName() string { return e.name }
...
func (e *SpeechEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SpeechEntity) Deleted() bool {
	return e.deleted
}


func (e *SpeechEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSpeechEntity(e.client, opts)
}

func (e *SpeechEntity) Data(args ...any) any {
...
func (e *SpeechEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Speech; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SpeechEntity) DataTyped(data ...Speech) Speech {
	if len(data) > 0 {
		return typedFrom[Speech](e.Data(asMap(data[0])))
	}
	return typedFrom[Speech](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Speech (all fields
// optional at the wire level).
func (e *SpeechEntity) MatchTyped(match ...Speech) Speech {
	if len(match) > 0 {
		return typedFrom[Speech](e.Match(asMap(match[0])))
	}
	return typedFrom[Speech](e.Match())
}
...
func (e *SpeechEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SpeechEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SpeechEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SpeechListMatch and returns []Speech. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SpeechEntity) ListTyped(reqmatch SpeechListMatch, ctrl map[string]any) ([]Speech, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Speech](res), nil
}



func (e *SpeechEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SpeechEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SpeechEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SpeechEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
