...
func NewMeetingEntity(client *core.KokkaiKaigirokuApiSDK, entopts map[string]any) *MeetingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MeetingEntity) GetName() string { return e.name }
...
func (e *MeetingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MeetingEntity) Deleted() bool {
	return e.deleted
}


func (e *MeetingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMeetingEntity(e.client, opts)
}

func (e *MeetingEntity) Data(args ...any) any {
...
func (e *MeetingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Meeting; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MeetingEntity) DataTyped(data ...Meeting) Meeting {
	if len(data) > 0 {
		return typedFrom[Meeting](e.Data(asMap(data[0])))
	}
	return typedFrom[Meeting](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Meeting (all fields
// optional at the wire level).
func (e *MeetingEntity) MatchTyped(match ...Meeting) Meeting {
	if len(match) > 0 {
		return typedFrom[Meeting](e.Match(asMap(match[0])))
	}
	return typedFrom[Meeting](e.Match())
}
...
func (e *MeetingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MeetingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *MeetingEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MeetingListMatch and returns []Meeting. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MeetingEntity) ListTyped(reqmatch MeetingListMatch, ctrl map[string]any) ([]Meeting, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Meeting](res), nil
}



func (e *MeetingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MeetingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MeetingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MeetingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
