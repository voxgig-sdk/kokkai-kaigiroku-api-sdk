...
type MeetingListEntity struct {
	name    string
	client  *core.KokkaiKaigirokuApiSDK
...
func NewMeetingListEntity(client *core.KokkaiKaigirokuApiSDK, entopts map[string]any) *MeetingListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MeetingListEntity) GetName() string { return e.name }
...
func (e *MeetingListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MeetingListEntity) Deleted() bool {
	return e.deleted
}


func (e *MeetingListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMeetingListEntity(e.client, opts)
}

func (e *MeetingListEntity) Data(args ...any) any {
...
func (e *MeetingListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MeetingList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MeetingListEntity) DataTyped(data ...MeetingList) MeetingList {
	if len(data) > 0 {
		return typedFrom[MeetingList](e.Data(asMap(data[0])))
	}
	return typedFrom[MeetingList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MeetingList (all fields
// optional at the wire level).
func (e *MeetingListEntity) MatchTyped(match ...MeetingList) MeetingList {
	if len(match) > 0 {
		return typedFrom[MeetingList](e.Match(asMap(match[0])))
	}
	return typedFrom[MeetingList](e.Match())
}
...
func (e *MeetingListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MeetingListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *MeetingListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MeetingListListMatch and returns []MeetingList. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MeetingListEntity) ListTyped(reqmatch MeetingListListMatch, ctrl map[string]any) ([]MeetingList, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[MeetingList](res), nil
}



func (e *MeetingListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MeetingListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MeetingListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MeetingListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
