...
The TypeScript SDK for the KokkaiKaigirokuApi API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new KokkaiKaigirokuApiSDK({ apikey: '...' })
