...
(0, node_test_1.describe)('MeetingListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.KokkaiKaigirokuApiSDK({
    ...
    (0, node_test_1.test)('direct-list-meeting_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-meeting_list', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.KOKKAI_KAIGIROKU_API_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.KokkaiKaigirokuApiSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['KOKKAI_KAIGIROKU_API_TEST_MEETING_LIST_ENTID'];
    ...
    const client = new __1.KokkaiKaigirokuApiSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=MeetingListDirect.test.js.map