...
(0, node_test_1.describe)('SpeechDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-speech', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-speech', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['KOKKAI_KAIGIROKU_API_TEST_SPEECH_ENTID'];
...
//# sourceMappingURL=SpeechDirect.test.js.map