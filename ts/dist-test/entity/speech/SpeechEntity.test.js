...
(0, node_test_1.describe)('SpeechEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/speech/SpeechTestData.json');
    ...
    let idmap = transform(['speech01', 'speech02', 'speech03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=SpeechEntity.test.js.map