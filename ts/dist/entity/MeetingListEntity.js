...
exports.MeetingListEntity = void 0;
const KokkaiKaigirokuApiEntityBase_1 = require("../KokkaiKaigirokuApiEntityBase");
// TODO: needs Entity superclass
class MeetingListEntity extends KokkaiKaigirokuApiEntityBase_1.KokkaiKaigirokuApiEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'meeting_list';
        this.name_ = 'meeting_list';
        this.Name = 'MeetingList';
    }
    make() {
        return new MeetingListEntity(this._client, this.entopts());
    }
...
exports.MeetingListEntity = MeetingListEntity;
//# sourceMappingURL=MeetingListEntity.js.map