...
The Ruby SDK for the KokkaiKaigirokuApi API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.KokkaiKaigirokuApi(nil).load(
  { "id" => "test01" }, nil
)
