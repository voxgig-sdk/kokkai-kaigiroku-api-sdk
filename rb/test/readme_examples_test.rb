...
#      offline in seeded test mode (KokkaiKaigirokuApiSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "KokkaiKaigirokuApi_sdk.rb")
  SDK_CLASS = "KokkaiKaigirokuApiSDK"
  ...
  SDK_BASE = "KokkaiKaigirokuApi_sdk"
