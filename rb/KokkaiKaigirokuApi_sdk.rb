...
require_relative 'KokkaiKaigirokuApi_types'
...
class KokkaiKaigirokuApiSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = KokkaiKaigirokuApiHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = KokkaiKaigirokuApiHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, KokkaiKaigirokuApiFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    KokkaiKaigirokuApiUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = KokkaiKaigirokuApiHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = KokkaiKaigirokuApiHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = KokkaiKaigirokuApiHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => KokkaiKaigirokuApiError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue KokkaiKaigirokuApiError => err
    ...
    if fetched.is_a?(Hash)
      status = KokkaiKaigirokuApiHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = KokkaiKaigirokuApiError.new(
        "graphql_error", "KokkaiKaigirokuApiSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = KokkaiKaigirokuApiSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
