# KokkaiKaigirokuApi SDK Meeting entity
...
class MeetingEntity
  ...
  def make
    opts = @_entopts.dup
    MeetingEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [MeetingListMatch, Hash, nil] match filter (any subset of
  #   Meeting fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Meeting>, Array] the matching Meeting items; raises KokkaiKaigirokuApiError on failure
