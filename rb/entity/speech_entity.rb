...
class SpeechEntity
  ...
  # @return [Speech, Hash] the current Speech data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Speech fields)
  def match_get
  ...
  #
  # @param reqmatch [SpeechListMatch, Hash, nil] match filter (any subset of
  #   Speech fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Speech>, Array] the matching Speech items; raises KokkaiKaigirokuApiError on failure
