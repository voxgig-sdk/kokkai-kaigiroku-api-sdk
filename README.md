...
This is an unofficial SDK for the 国会会議録検索 public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/kokkai-kaigiroku-api` | `npm install @voxgig-sdk/kokkai-kaigiroku-api` |
| Python | `voxgig-sdk-kokkai-kaigiroku-api` | `pip install voxgig-sdk-kokkai-kaigiroku-api` |
| PHP | `voxgig-sdk/kokkai-kaigiroku-api` | `composer require voxgig-sdk/kokkai-kaigiroku-api` |
| Golang | `github.com/voxgig-sdk/kokkai-kaigiroku-api-sdk/go` | `go get github.com/voxgig-sdk/kokkai-kaigiroku-api-sdk/go` |
| Ruby | `voxgig-sdk-kokkai-kaigiroku-api` | `gem install voxgig-sdk-kokkai-kaigiroku-api` |
| Lua | `voxgig-sdk-kokkai-kaigiroku-api` | `luarocks install voxgig-sdk-kokkai-kaigiroku-api` |
...
- Upstream API: [https://kokkai.ndl.go.jp/api.html](https://kokkai.ndl.go.jp/api.html)
